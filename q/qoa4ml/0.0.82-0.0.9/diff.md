# Comparing `tmp/qoa4ml-0.0.82.tar.gz` & `tmp/qoa4ml-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/qoa4ml-0.0.82.tar", last modified: Fri May 26 11:02:58 2023, max compression
...
## Comparing `qoa4ml-0.0.82.tar` & `qoa4ml-0.0.9.tar`

### file list

```diff
@@ -1,36 +1,34 @@
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.785219 qoa4ml-0.0.82/
--rw-r--r--   0 tringuyen   (501) wheel        (0)      563 2023-05-22 14:23:36.000000 qoa4ml-0.0.82/CHANGELOG.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1047 2022-03-23 13:04:50.000000 qoa4ml-0.0.82/LICENCE.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)       30 2022-03-23 13:04:50.000000 qoa4ml-0.0.82/MANIFEST.in
--rw-r--r--   0 tringuyen   (501) wheel        (0)     9190 2023-05-26 11:02:58.784919 qoa4ml-0.0.82/PKG-INFO
--rw-r--r--   0 tringuyen   (501) wheel        (0)     6843 2023-05-22 10:07:32.000000 qoa4ml-0.0.82/README.md
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.779481 qoa4ml-0.0.82/conf/
--rw-r--r--   0 tringuyen   (501) wheel        (0)      122 2023-05-22 08:28:02.000000 qoa4ml-0.0.82/conf/client.json
--rw-r--r--   0 tringuyen   (501) wheel        (0)      287 2023-04-18 14:34:40.000000 qoa4ml-0.0.82/conf/collector.json
--rw-r--r--   0 tringuyen   (501) wheel        (0)      251 2022-05-10 09:59:56.000000 qoa4ml-0.0.82/conf/connector.json
--rw-r--r--   0 tringuyen   (501) wheel        (0)      343 2023-05-21 08:59:44.000000 qoa4ml-0.0.82/conf/metrics.json
--rw-r--r--   0 tringuyen   (501) wheel        (0)      795 2022-06-01 03:09:16.000000 qoa4ml-0.0.82/conf/system_metric.json
--rw-r--r--   0 tringuyen   (501) wheel        (0)       84 2022-09-02 11:22:46.000000 qoa4ml-0.0.82/pyproject.toml
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.781003 qoa4ml-0.0.82/qoa4ml/
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2022-03-18 16:53:28.000000 qoa4ml-0.0.82/qoa4ml/__init__.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.782827 qoa4ml-0.0.82/qoa4ml/collector/
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2022-03-23 14:05:26.000000 qoa4ml-0.0.82/qoa4ml/collector/__init__.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2120 2023-01-30 17:43:18.000000 qoa4ml-0.0.82/qoa4ml/collector/amqp_collector.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.784433 qoa4ml-0.0.82/qoa4ml/connector/
--rw-r--r--   0 tringuyen   (501) wheel        (0)        0 2022-03-23 14:05:29.000000 qoa4ml-0.0.82/qoa4ml/connector/__init__.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2093 2023-01-30 16:55:55.000000 qoa4ml-0.0.82/qoa4ml/connector/amqp_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1379 2022-03-23 09:27:48.000000 qoa4ml-0.0.82/qoa4ml/connector/mess_logging.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     1611 2022-03-23 09:32:08.000000 qoa4ml-0.0.82/qoa4ml/connector/mqtt_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     2189 2022-03-23 09:33:14.000000 qoa4ml-0.0.82/qoa4ml/connector/prom_connector.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     4162 2023-05-25 14:14:17.000000 qoa4ml-0.0.82/qoa4ml/probes.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)    10527 2023-05-26 11:02:39.000000 qoa4ml-0.0.82/qoa4ml/qoa_client.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     4470 2023-05-22 08:59:17.000000 qoa4ml-0.0.82/qoa4ml/reports.py
--rw-r--r--   0 tringuyen   (501) wheel        (0)     9789 2023-05-26 07:48:38.000000 qoa4ml-0.0.82/qoa4ml/utils.py
-drwxr-xr-x   0 tringuyen   (501) wheel        (0)        0 2023-05-26 11:02:58.782324 qoa4ml-0.0.82/qoa4ml.egg-info/
--rw-r--r--   0 tringuyen   (501) wheel        (0)     9190 2023-05-26 11:02:58.000000 qoa4ml-0.0.82/qoa4ml.egg-info/PKG-INFO
--rw-r--r--   0 tringuyen   (501) wheel        (0)      641 2023-05-26 11:02:58.000000 qoa4ml-0.0.82/qoa4ml.egg-info/SOURCES.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)        1 2023-05-26 11:02:58.000000 qoa4ml-0.0.82/qoa4ml.egg-info/dependency_links.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)       56 2023-05-26 11:02:58.000000 qoa4ml-0.0.82/qoa4ml.egg-info/requires.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)        7 2023-05-26 11:02:58.000000 qoa4ml-0.0.82/qoa4ml.egg-info/top_level.txt
--rw-r--r--   0 tringuyen   (501) wheel        (0)       38 2023-05-26 11:02:58.785310 qoa4ml-0.0.82/setup.cfg
--rw-r--r--   0 tringuyen   (501) wheel        (0)      585 2023-05-26 11:02:56.000000 qoa4ml-0.0.82/setup.py
...
### Comparing `qoa4ml-0.0.82/LICENCE.txt` & `qoa4ml-0.0.9/LICENCE.txt`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.82/qoa4ml/collector/amqp_collector.py` & `qoa4ml-0.0.9/qoa4ml/collector/qmqp_collector.py`
...
### Comparing `qoa4ml-0.0.82/qoa4ml/connector/amqp_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/amqp_client.py`
...
### Comparing `qoa4ml-0.0.82/qoa4ml/connector/mess_logging.py` & `qoa4ml-0.0.9/qoa4ml/connector/mess_logging.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.82/qoa4ml/connector/mqtt_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/mqtt_client.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.82/qoa4ml/connector/prom_connector.py` & `qoa4ml-0.0.9/qoa4ml/connector/prom_connector.py`

 * *Files identical despite different names*

### Comparing `qoa4ml-0.0.82/qoa4ml.egg-info/SOURCES.txt` & `qoa4ml-0.0.9/qoa4ml/qoa4ml.egg-info/SOURCES.txt`
...
### Comparing `qoa4ml-0.0.82/setup.py` & `qoa4ml-0.0.9/setup.py`
