# Comparing `tmp/oarepo-model-builder-4.0.7.tar.gz` & `tmp/oarepo-model-builder-4.0.8.tar.gz`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/mapping.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/mapping.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/model_saver.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/model_saver.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/python.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/python.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/python_structure.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/python_structure.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builders/utils.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builders/utils.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/builtin_models/invenio.json` & `oarepo-model-builder-4.0.8/oarepo_model_builder/builtin_models/invenio.json`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/cli.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/cli.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/enum.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/enum.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/facets/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/facets/__init__.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/facets/array.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/facets/array.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/facets/field.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/facets/field.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/facets/nested.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/facets/nested.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/facets/object.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/facets/object.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/array.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/array.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/field.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/field.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/graph.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/graph.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/object.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/object.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/ui_array.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/ui_array.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/ui_field.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/ui_field.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/marshmallow/ui_object.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/marshmallow/ui_object.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/app.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/app.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/blueprints.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/blueprints.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/defaults.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/defaults.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/facets.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/facets.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/jsonschema.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/jsonschema.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/mapping.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/mapping.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/marshmallow.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/marshmallow.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/model_saver.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/model_saver.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/permissions.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/permissions.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/pid.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/pid.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/plugins.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/plugins.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/proxy.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/proxy.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/record.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/record.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/record_dumper.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/record_dumper.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/record_metadata.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/record_metadata.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/resource.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/resource.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/sample.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/sample.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/search_options.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/search_options.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/service.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/service.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/ui.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/ui.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/ui_marshmallow.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/ui_marshmallow.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/model/utils.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/model/utils.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/sample.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/sample.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/components/ui.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/components/ui.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/containers/array.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/containers/array.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/containers/object.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/containers/object.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/datatypes.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/datatypes.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/dates.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/dates.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/model.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/model.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/primitive_types.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/primitive_types.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/datatypes/strings.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/datatypes/strings.py`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/entrypoints.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/entrypoints.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/fs.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/fs.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/generate_doc.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/generate_doc.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_base.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_base.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_ext_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_ext_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_facets.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_facets.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_jsonschemas_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_jsonschemas_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_marshmallow.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_marshmallow.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_metadata_alembic_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_metadata_alembic_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_metadata_models_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_metadata_models_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_resource_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_resource_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_search_options.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_search_options.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_search_setup_cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_search_setup_cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_record_service_config.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_record_service_config.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/invenio_script_sample_data.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/invenio_script_sample_data.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/api_views.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/api_views.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/app_views.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/app_views.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/config.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/config.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/ext.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/ext.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/invenio_record_search_options.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/invenio_record_search_options.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/marshmallow.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/marshmallow.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/permissions.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/permissions.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/record.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/record.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/resource_config.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/resource_config.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/invenio/templates/service_config.py.jinja2` & `oarepo-model-builder-4.0.8/oarepo_model_builder/invenio/templates/service_config.py.jinja2`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/loaders/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/loaders/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/merger.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/merger.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/cfg.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/cfg.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/diff.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/diff.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/json.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/json.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/json_stack.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/json_stack.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/python.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/python.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/text.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/text.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/toml.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/toml.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/outputs/yaml.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/outputs/yaml.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/profiles/record.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/profiles/record.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/schema.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/schema.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/templates/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/templates/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/call.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/call.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/collections.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/collections.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/common.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/common.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/indented_nodes.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/indented_nodes.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/mergers.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/mergers.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/cst/simple_nodes.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/cst/simple_nodes.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/deepmerge.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/deepmerge.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/facet_helpers.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/facet_helpers.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/jinja.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/jinja.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/properties.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/properties.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/python_name.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/python_name.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/utils/verbose.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/utils/verbose.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/validation/__init__.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/validation/__init__.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/validation/extensibility.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/validation/extensibility.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/validation/model_validation.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/validation/model_validation.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder/validation/utils.py` & `oarepo-model-builder-4.0.8/oarepo_model_builder/validation/utils.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder.egg-info/PKG-INFO` & `oarepo-model-builder-4.0.8/oarepo_model_builder.egg-info/PKG-INFO`
...
### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder.egg-info/SOURCES.txt` & `oarepo-model-builder-4.0.8/oarepo_model_builder.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/oarepo_model_builder.egg-info/entry_points.txt` & `oarepo-model-builder-4.0.8/oarepo_model_builder.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/setup.cfg` & `oarepo-model-builder-4.0.8/setup.cfg`
...
### Comparing `oarepo-model-builder-4.0.7/tests/multilang.py` & `oarepo-model-builder-4.0.8/tests/multilang.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_builder_from_entrypoints.py` & `oarepo-model-builder-4.0.8/tests/test_builder_from_entrypoints.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_cfg_builders.py` & `oarepo-model-builder-4.0.8/tests/test_cfg_builders.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_datatype_prepare.py` & `oarepo-model-builder-4.0.8/tests/test_datatype_prepare.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_datatype_validator.py` & `oarepo-model-builder-4.0.8/tests/test_datatype_validator.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_dependencies.py` & `oarepo-model-builder-4.0.8/tests/test_dependencies.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_empty_metadata.py` & `oarepo-model-builder-4.0.8/tests/test_empty_metadata.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_extend.py` & `oarepo-model-builder-4.0.8/tests/test_extend.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_facets.py` & `oarepo-model-builder-4.0.8/tests/test_facets.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_fulltext_keyword.py` & `oarepo-model-builder-4.0.8/tests/test_fulltext_keyword.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_jsonchema_builder.py` & `oarepo-model-builder-4.0.8/tests/test_jsonchema_builder.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_loading.py` & `oarepo-model-builder-4.0.8/tests/test_loading.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_mapping_builder.py` & `oarepo-model-builder-4.0.8/tests/test_mapping_builder.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_marshmallow_builder.py` & `oarepo-model-builder-4.0.8/tests/test_marshmallow_builder.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_marshmallow_ui_builder.py` & `oarepo-model-builder-4.0.8/tests/test_marshmallow_ui_builder.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_merge.py` & `oarepo-model-builder-4.0.8/tests/test_merge.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_model_saver.py` & `oarepo-model-builder-4.0.8/tests/test_model_saver.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_overwrite.py` & `oarepo-model-builder-4.0.8/tests/test_overwrite.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_pid_provider.py` & `oarepo-model-builder-4.0.8/tests/test_pid_provider.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_plugin_configuration.py` & `oarepo-model-builder-4.0.8/tests/test_plugin_configuration.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_python_mergers.py` & `oarepo-model-builder-4.0.8/tests/test_python_mergers.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_raw.py` & `oarepo-model-builder-4.0.8/tests/test_raw.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_sample_builder.py` & `oarepo-model-builder-4.0.8/tests/test_sample_builder.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_schema_props.py` & `oarepo-model-builder-4.0.8/tests/test_schema_props.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_search_options.py` & `oarepo-model-builder-4.0.8/tests/test_search_options.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_shortcuts.py` & `oarepo-model-builder-4.0.8/tests/test_shortcuts.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_simple_builders.py` & `oarepo-model-builder-4.0.8/tests/test_simple_builders.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_type_shortcuts.py` & `oarepo-model-builder-4.0.8/tests/test_type_shortcuts.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/test_validation.py` & `oarepo-model-builder-4.0.8/tests/test_validation.py`

 * *Files identical despite different names*

### Comparing `oarepo-model-builder-4.0.7/tests/utils.py` & `oarepo-model-builder-4.0.8/tests/utils.py`
