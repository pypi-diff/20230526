# Comparing `tmp/pickled_carrots-1.0.1.tar.gz` & `tmp/pickled_carrots-1.0.2.tar.gz`
...
### Comparing `pickled_carrots-1.0.1/pickled_carrots/waveforms.py` & `pickled_carrots-1.0.2/pickled_carrots/waveforms.py`
