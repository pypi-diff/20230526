# Comparing `tmp/pycorekit-0.0.3.tar.gz` & `tmp/pycorekit-0.0.4.tar.gz`
...
## Comparing `pycorekit-0.0.3.tar` & `pycorekit-0.0.4.tar`
...
### Comparing `pycorekit-0.0.3/LICENSE.txt` & `pycorekit-0.0.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `pycorekit-0.0.3/PKG-INFO` & `pycorekit-0.0.4/PKG-INFO`
...
### Comparing `pycorekit-0.0.3/pycorekit.egg-info/PKG-INFO` & `pycorekit-0.0.4/pycorekit.egg-info/PKG-INFO`
...
### Comparing `pycorekit-0.0.3/setup.py` & `pycorekit-0.0.4/setup.py`
