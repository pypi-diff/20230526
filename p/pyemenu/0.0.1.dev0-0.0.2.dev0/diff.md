# Comparing `tmp/pyemenu-0.0.1.dev0.tar.gz` & `tmp/pyemenu-0.0.2.dev0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyemenu-0.0.1.dev0.tar", last modified: Fri May 26 21:43:19 2023, max compression
+gzip compressed data, was "pyemenu-0.0.2.dev0.tar", last modified: Fri May 26 21:52:28 2023, max compression
```

## Comparing `pyemenu-0.0.1.dev0.tar` & `pyemenu-0.0.2.dev0.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 zero      (1000) zero      (1000)        0 2023-05-26 21:43:19.178343 pyemenu-0.0.1.dev0/
--rw-r--r--   0 zero      (1000) zero      (1000)     1083 2023-05-26 17:53:37.000000 pyemenu-0.0.1.dev0/LICENSE.txt
--rw-r--r--   0 zero      (1000) zero      (1000)     4253 2023-05-26 21:43:19.178343 pyemenu-0.0.1.dev0/PKG-INFO
--rw-r--r--   0 zero      (1000) zero      (1000)     3283 2023-05-26 21:26:51.000000 pyemenu-0.0.1.dev0/README.md
-drwxr-xr-x   0 zero      (1000) zero      (1000)        0 2023-05-26 21:43:19.175010 pyemenu-0.0.1.dev0/pyemenu/
--rw-r--r--   0 zero      (1000) zero      (1000)       38 2023-05-26 21:38:36.000000 pyemenu-0.0.1.dev0/pyemenu/__init__.py
--rw-r--r--   0 zero      (1000) zero      (1000)     3308 2023-05-26 21:04:58.000000 pyemenu-0.0.1.dev0/pyemenu/pyemenu.py
-drwxr-xr-x   0 zero      (1000) zero      (1000)        0 2023-05-26 21:43:19.178343 pyemenu-0.0.1.dev0/pyemenu.egg-info/
--rw-r--r--   0 zero      (1000) zero      (1000)     4253 2023-05-26 21:43:19.000000 pyemenu-0.0.1.dev0/pyemenu.egg-info/PKG-INFO
--rw-r--r--   0 zero      (1000) zero      (1000)      237 2023-05-26 21:43:19.000000 pyemenu-0.0.1.dev0/pyemenu.egg-info/SOURCES.txt
--rw-r--r--   0 zero      (1000) zero      (1000)        1 2023-05-26 21:43:19.000000 pyemenu-0.0.1.dev0/pyemenu.egg-info/dependency_links.txt
--rw-r--r--   0 zero      (1000) zero      (1000)        9 2023-05-26 21:43:19.000000 pyemenu-0.0.1.dev0/pyemenu.egg-info/requires.txt
--rw-r--r--   0 zero      (1000) zero      (1000)        8 2023-05-26 21:43:19.000000 pyemenu-0.0.1.dev0/pyemenu.egg-info/top_level.txt
--rw-r--r--   0 zero      (1000) zero      (1000)       38 2023-05-26 21:43:19.178343 pyemenu-0.0.1.dev0/setup.cfg
--rw-r--r--   0 zero      (1000) zero      (1000)     2116 2023-05-26 21:43:14.000000 pyemenu-0.0.1.dev0/setup.py
-drwxr-xr-x   0 zero      (1000) zero      (1000)        0 2023-05-26 21:43:19.178343 pyemenu-0.0.1.dev0/tests/
--rw-r--r--   0 zero      (1000) zero      (1000)        2 2023-05-26 19:16:06.000000 pyemenu-0.0.1.dev0/tests/test.py
...
### Comparing `pyemenu-0.0.1.dev0/LICENSE.txt` & `pyemenu-0.0.2.dev0/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `pyemenu-0.0.1.dev0/PKG-INFO` & `pyemenu-0.0.2.dev0/PKG-INFO`
...
### Comparing `pyemenu-0.0.1.dev0/README.md` & `pyemenu-0.0.2.dev0/README.md`

 * *Files identical despite different names*

### Comparing `pyemenu-0.0.1.dev0/pyemenu/pyemenu.py` & `pyemenu-0.0.2.dev0/pyemenu/pyemenu.py`

 * *Files identical despite different names*

### Comparing `pyemenu-0.0.1.dev0/pyemenu.egg-info/PKG-INFO` & `pyemenu-0.0.2.dev0/pyemenu.egg-info/PKG-INFO`
...
### Comparing `pyemenu-0.0.1.dev0/setup.py` & `pyemenu-0.0.2.dev0/setup.py`
