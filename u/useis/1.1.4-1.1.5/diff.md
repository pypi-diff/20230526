# Comparing `tmp/useis-1.1.4.tar.gz` & `tmp/useis-1.1.5.tar.gz`
...
## Comparing `useis-1.1.4.tar` & `useis-1.1.5.tar`
...
### Comparing `useis-1.1.4/LICENSE` & `useis-1.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/pyproject.toml` & `useis-1.1.5/pyproject.toml`
...
### Comparing `useis-1.1.4/useis/ai/create-picking_dataset.py` & `useis-1.1.5/useis/ai/create-picking_dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/create_classification_dataset.py` & `useis-1.1.5/useis/ai/create_classification_dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/database.py` & `useis-1.1.5/useis/ai/database.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/dataset.py` & `useis-1.1.5/useis/ai/dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/event_type_lookup.py` & `useis-1.1.5/useis/ai/event_type_lookup.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/model.py` & `useis-1.1.5/useis/ai/model.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/resnet1d.py` & `useis-1.1.5/useis/ai/resnet1d.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/ai/spectrogram.py` & `useis-1.1.5/useis/ai/spectrogram.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/clients/test_data.py` & `useis-1.1.5/useis/clients/test_data.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/core/project_manager.py` & `useis-1.1.5/useis/core/project_manager.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/core/projection.py` & `useis-1.1.5/useis/core/projection.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/examples/classifier/classifier.py` & `useis-1.1.5/useis/examples/classifier/classifier.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/examples/classifier/example.ipynb` & `useis-1.1.5/useis/examples/classifier/example.ipynb`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/beamforming.py` & `useis-1.1.5/useis/processors/beamforming.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/data_extractor.py` & `useis-1.1.5/useis/processors/data_extractor.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/file_manager.py` & `useis-1.1.5/useis/processors/file_manager.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/magnitude.py` & `useis-1.1.5/useis/processors/magnitude.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/nlloc.py` & `useis-1.1.5/useis/processors/nlloc.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/picker.py` & `useis-1.1.5/useis/processors/picker.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/simple_magnitude.py` & `useis-1.1.5/useis/processors/simple_magnitude.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/processors/tomography.py` & `useis-1.1.5/useis/processors/tomography.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/ai_picker/train_picker.py` & `useis-1.1.5/useis/sandbox/ai_picker/train_picker.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/demo_kafka/Dockerfile` & `useis-1.1.5/useis/sandbox/demo_kafka/Dockerfile`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/demo_kafka/consumer.py` & `useis-1.1.5/useis/sandbox/demo_kafka/consumer.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/demo_kafka/docker-compose.yml` & `useis-1.1.5/useis/sandbox/demo_kafka/docker-compose.yml`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/00_create_training_dataset.py` & `useis-1.1.5/useis/sandbox/event_classification/00_create_training_dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/01_train.py` & `useis-1.1.5/useis/sandbox/event_classification/01_train.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/02_test.py` & `useis-1.1.5/useis/sandbox/event_classification/02_test.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/event_type_lookup.py` & `useis-1.1.5/useis/sandbox/event_classification/event_type_lookup.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/inventory/OT.xml` & `useis-1.1.5/useis/sandbox/event_classification/inventory/OT.xml`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/inventory/OT_old.xml` & `useis-1.1.5/useis/sandbox/event_classification/inventory/OT_old.xml`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/inventory/update_inventory.py` & `useis-1.1.5/useis/sandbox/event_classification/inventory/update_inventory.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/event_classification/velocity.py` & `useis-1.1.5/useis/sandbox/event_classification/velocity.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/tomography/Tomography.ipynb` & `useis-1.1.5/useis/sandbox/tomography/Tomography.ipynb`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/sandbox/tomography/test_tomography.py` & `useis-1.1.5/useis/sandbox/tomography/test_tomography.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/create-picking_dataset.py` & `useis-1.1.5/useis/scripts/ai/create-picking_dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/create_classification_dataset.py` & `useis-1.1.5/useis/scripts/ai/create_classification_dataset.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/create_classification_dataset_1D.py` & `useis-1.1.5/useis/scripts/ai/create_classification_dataset_1D.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/train_classifier.py` & `useis-1.1.5/useis/scripts/ai/train_classifier.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/train_classifier_1d.py` & `useis-1.1.5/useis/scripts/ai/train_classifier_1d.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/scripts/ai/train_picker.py` & `useis-1.1.5/useis/scripts/ai/train_picker.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/file_server/database.py` & `useis-1.1.5/useis/services/file_server/database.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/file_server/indexer.py` & `useis-1.1.5/useis/services/file_server/indexer.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/grid/client.py` & `useis-1.1.5/useis/services/grid/client.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/grid/server.py` & `useis-1.1.5/useis/services/grid/server.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/grid/test.py` & `useis-1.1.5/useis/services/grid/test.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/models/classifier.py` & `useis-1.1.5/useis/services/models/classifier.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/models/event.py` & `useis-1.1.5/useis/services/models/event.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/models/grid.py` & `useis-1.1.5/useis/services/models/grid.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/services/models/nlloc.py` & `useis-1.1.5/useis/services/models/nlloc.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/settings/nlloc_settings_template.py` & `useis-1.1.5/useis/settings/nlloc_settings_template.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/settings/picker_settings_template.toml` & `useis-1.1.5/useis/settings/picker_settings_template.toml`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/settings/settings.py` & `useis-1.1.5/useis/settings/settings.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/settings/settings_template.toml` & `useis-1.1.5/useis/settings/settings_template.toml`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/useis/tomography/data.py` & `useis-1.1.5/useis/tomography/data.py`

 * *Files identical despite different names*

### Comparing `useis-1.1.4/setup.py` & `useis-1.1.5/setup.py`
...
### Comparing `useis-1.1.4/PKG-INFO` & `useis-1.1.5/PKG-INFO`
