# Comparing `tmp/ucampurestorage-1.1.1.tar.gz` & `tmp/ucampurestorage-1.1.2.tar.gz`
...
### Comparing `ucampurestorage-1.1.1/docs/access3.JPG` & `ucampurestorage-1.1.2/docs/access3.JPG`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/access4.JPG` & `ucampurestorage-1.1.2/docs/access4.JPG`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/access5.JPG` & `ucampurestorage-1.1.2/docs/access5.JPG`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/access6.JPG` & `ucampurestorage-1.1.2/docs/access6.JPG`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/changelog.rst` & `ucampurestorage-1.1.2/docs/changelog.rst`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/conf.py` & `ucampurestorage-1.1.2/docs/conf.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/index.rst` & `ucampurestorage-1.1.2/docs/index.rst`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/make.bat` & `ucampurestorage-1.1.2/docs/make.bat`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/pure_storage.jpg` & `ucampurestorage-1.1.2/docs/pure_storage.jpg`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/ucampurestorage.lib.rst` & `ucampurestorage-1.1.2/docs/ucampurestorage.lib.rst`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/docs/ucampurestorage.tests.rst` & `ucampurestorage-1.1.2/docs/ucampurestorage.tests.rst`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/pure_storage.jpg` & `ucampurestorage-1.1.2/pure_storage.jpg`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/pyproject.toml` & `ucampurestorage-1.1.2/pyproject.toml`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/test.sh` & `ucampurestorage-1.1.2/test.sh`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/tox.ini` & `ucampurestorage-1.1.2/tox.ini`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/README.md` & `ucampurestorage-1.1.2/ucampurecli/README.md`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_clone_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_clone_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_create_snapshot` & `ucampurestorage-1.1.2/ucampurecli/pure_create_snapshot`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_create_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_create_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_delete_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_delete_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_eradicate_destroyed_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_eradicate_destroyed_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_eradicate_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_eradicate_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_map_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_map_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_record_destoyed_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_record_destoyed_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_replace_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_replace_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurecli/pure_unmap_volume` & `ucampurestorage-1.1.2/ucampurecli/pure_unmap_volume`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/__main__.py` & `ucampurestorage-1.1.2/ucampurestorage/__main__.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/lib/httpclient.py` & `ucampurestorage-1.1.2/ucampurestorage/lib/httpclient.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/lib/options.py` & `ucampurestorage-1.1.2/ucampurestorage/lib/options.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/lib/process.py` & `ucampurestorage-1.1.2/ucampurestorage/lib/process.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/lib/pureconnect.py` & `ucampurestorage-1.1.2/ucampurestorage/lib/pureconnect.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/lib/tokencreater.py` & `ucampurestorage-1.1.2/ucampurestorage/lib/tokencreater.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/tests/test_httpclient.py` & `ucampurestorage-1.1.2/ucampurestorage/tests/test_httpclient.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/tests/test_process.py` & `ucampurestorage-1.1.2/ucampurestorage/tests/test_process.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/tests/test_pureconnection.py` & `ucampurestorage-1.1.2/ucampurestorage/tests/test_pureconnection.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage/tests/test_tokencreater.py` & `ucampurestorage-1.1.2/ucampurestorage/tests/test_tokencreater.py`

 * *Files identical despite different names*

### Comparing `ucampurestorage-1.1.1/ucampurestorage.egg-info/PKG-INFO` & `ucampurestorage-1.1.2/ucampurestorage.egg-info/PKG-INFO`
...
### Comparing `ucampurestorage-1.1.1/ucampurestorage.egg-info/SOURCES.txt` & `ucampurestorage-1.1.2/ucampurestorage.egg-info/SOURCES.txt`
