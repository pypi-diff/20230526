# Comparing `tmp/config_joker-0.5.0.tar.gz` & `tmp/config_joker-0.6.0.tar.gz`
...
## Comparing `config_joker-0.5.0.tar` & `config_joker-0.6.0.tar`
...
### Comparing `config_joker-0.5.0/LICENSE` & `config_joker-0.6.0/LICENSE`

 * *Files identical despite different names*

### Comparing `config_joker-0.5.0/README.md` & `config_joker-0.6.0/README.md`

 * *Files identical despite different names*

### Comparing `config_joker-0.5.0/pyproject.toml` & `config_joker-0.6.0/pyproject.toml`
...
### Comparing `config_joker-0.5.0/PKG-INFO` & `config_joker-0.6.0/PKG-INFO`
