# Comparing `tmp/edu_segmentation-0.0.84.tar.gz` & `tmp/edu_segmentation-0.0.85.tar.gz`
...
### Comparing `edu_segmentation-0.0.84/readme.md` & `edu_segmentation-0.0.85/readme.md`
