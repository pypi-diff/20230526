# Comparing `tmp/digital_unit-1.5.1.tar.gz` & `tmp/digital_unit-1.5b0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "digital_unit-1.5.1.tar", last modified: Fri May 26 13:17:52 2023, max compression
+gzip compressed data, was "digital_unit-1.5b0.tar", last modified: Thu May 25 14:15:13 2023, max compression
```

## Comparing `digital_unit-1.5.1.tar` & `digital_unit-1.5b0.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxrwxrwx   0        0        0        0 2023-05-26 13:17:52.320480 digital_unit-1.5.1/
--rw-rw-rw-   0        0        0      240 2023-05-26 13:17:52.319480 digital_unit-1.5.1/PKG-INFO
-drwxrwxrwx   0        0        0        0 2023-05-26 13:17:52.301480 digital_unit-1.5.1/digital_unit/
--rw-rw-rw-   0        0        0      827 2023-05-24 12:55:31.000000 digital_unit-1.5.1/digital_unit/Area.py
--rw-rw-rw-   0        0        0      797 2023-05-24 12:55:26.000000 digital_unit-1.5.1/digital_unit/Lenth.py
--rw-rw-rw-   0        0        0      137 2023-05-26 13:16:29.000000 digital_unit-1.5.1/digital_unit/__init__.py
--rw-rw-rw-   0        0        0     1050 2023-05-24 14:05:13.000000 digital_unit-1.5.1/digital_unit/root.py
--rw-rw-rw-   0        0        0      330 2023-05-25 13:54:40.000000 digital_unit-1.5.1/digital_unit/sample.py
--rw-rw-rw-   0        0        0      294 2023-05-25 14:15:08.000000 digital_unit-1.5.1/digital_unit/volume.py
-drwxrwxrwx   0        0        0        0 2023-05-26 13:17:52.315493 digital_unit-1.5.1/digital_unit.egg-info/
--rw-rw-rw-   0        0        0      240 2023-05-26 13:17:52.000000 digital_unit-1.5.1/digital_unit.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      287 2023-05-26 13:17:52.000000 digital_unit-1.5.1/digital_unit.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-26 13:17:52.000000 digital_unit-1.5.1/digital_unit.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       13 2023-05-26 13:17:52.000000 digital_unit-1.5.1/digital_unit.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2023-05-26 13:17:52.320480 digital_unit-1.5.1/setup.cfg
--rw-rw-rw-   0        0        0      776 2023-05-26 13:17:43.000000 digital_unit-1.5.1/setup.py
...
### Comparing `digital_unit-1.5.1/digital_unit/Area.py` & `digital_unit-1.5b0/digital_unit/Area.py`

 * *Files identical despite different names*

### Comparing `digital_unit-1.5.1/digital_unit/Lenth.py` & `digital_unit-1.5b0/digital_unit/Lenth.py`

 * *Files identical despite different names*

### Comparing `digital_unit-1.5.1/digital_unit/root.py` & `digital_unit-1.5b0/digital_unit/root.py`

 * *Files identical despite different names*

### Comparing `digital_unit-1.5.1/setup.py` & `digital_unit-1.5b0/setup.py`
