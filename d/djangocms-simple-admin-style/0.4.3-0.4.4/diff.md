# Comparing `tmp/djangocms-simple-admin-style-0.4.3.tar.gz` & `tmp/djangocms-simple-admin-style-0.4.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "djangocms-simple-admin-style-0.4.3.tar", last modified: Wed May 24 19:47:51 2023, max compression
+gzip compressed data, was "djangocms-simple-admin-style-0.4.4.tar", last modified: Fri May 26 12:33:35 2023, max compression
```

## Comparing `djangocms-simple-admin-style-0.4.3.tar` & `djangocms-simple-admin-style-0.4.4.tar`

### file list

```diff
@@ -1,25 +1,25 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.439852 djangocms-simple-admin-style-0.4.3/
--rw-r--r--   0 runner    (1001) docker     (123)     1479 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)      218 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     4253 2023-05-24 19:47:51.439852 djangocms-simple-admin-style-0.4.3/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     2363 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/README.rst
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/
--rw-r--r--   0 runner    (1001) docker     (123)       22 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/static/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/static/djangocms_simple_admin_style/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/static/djangocms_simple_admin_style/css/
--rw-r--r--   0 runner    (1001) docker     (123)     8004 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/static/djangocms_simple_admin_style/css/djangocms-simple-admin.min.css
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/admin/
--rw-r--r--   0 runner    (1001) docker     (123)      594 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/admin/base_site.html
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.439852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/admin/inc/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/admin/inc/extrastyle.html
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 19:47:51.435852 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     4253 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      625 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)       11 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       29 2023-05-24 19:47:51.000000 djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      559 2023-05-24 19:47:51.439852 djangocms-simple-admin-style-0.4.3/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     2309 2023-05-24 19:47:42.000000 djangocms-simple-admin-style-0.4.3/setup.py
...
### Comparing `djangocms-simple-admin-style-0.4.3/LICENSE` & `djangocms-simple-admin-style-0.4.4/LICENSE`

 * *Files identical despite different names*

### Comparing `djangocms-simple-admin-style-0.4.3/PKG-INFO` & `djangocms-simple-admin-style-0.4.4/PKG-INFO`
...
### Comparing `djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style/templates/admin/base_site.html` & `djangocms-simple-admin-style-0.4.4/djangocms_simple_admin_style/templates/admin/base_site.html`

 * *Files identical despite different names*

### Comparing `djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/PKG-INFO` & `djangocms-simple-admin-style-0.4.4/djangocms_simple_admin_style.egg-info/PKG-INFO`
...
### Comparing `djangocms-simple-admin-style-0.4.3/djangocms_simple_admin_style.egg-info/SOURCES.txt` & `djangocms-simple-admin-style-0.4.4/djangocms_simple_admin_style.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `djangocms-simple-admin-style-0.4.3/setup.cfg` & `djangocms-simple-admin-style-0.4.4/setup.cfg`

 * *Files identical despite different names*

### Comparing `djangocms-simple-admin-style-0.4.3/setup.py` & `djangocms-simple-admin-style-0.4.4/setup.py`
