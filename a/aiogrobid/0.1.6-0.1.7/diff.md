# Comparing `tmp/aiogrobid-0.1.6.tar.gz` & `tmp/aiogrobid-0.1.7.tar.gz`
...
## Comparing `aiogrobid-0.1.6.tar` & `aiogrobid-0.1.7.tar`
...
### Comparing `aiogrobid-0.1.6/LICENSE` & `aiogrobid-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `aiogrobid-0.1.6/PKG-INFO` & `aiogrobid-0.1.7/PKG-INFO`
...
### Comparing `aiogrobid-0.1.6/README.md` & `aiogrobid-0.1.7/README.md`

 * *Files identical despite different names*

### Comparing `aiogrobid-0.1.6/aiogrobid/client.py` & `aiogrobid-0.1.7/aiogrobid/client.py`
...
### Comparing `aiogrobid-0.1.6/aiogrobid.egg-info/PKG-INFO` & `aiogrobid-0.1.7/aiogrobid.egg-info/PKG-INFO`
...
### Comparing `aiogrobid-0.1.6/setup.cfg` & `aiogrobid-0.1.7/setup.cfg`
